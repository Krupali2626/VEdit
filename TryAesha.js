    ...
    const handleMouseMove = (e) => {
      if (resizeDirection || isDragging) {
        ...
        if (resizeDirection) {
          ...
          const maxX = previewBounds.width - containerBounds.width;
          const maxY = previewBounds.height - containerBounds.height;
      ...
      <div className="row w-100">
        ...
        <div className="col-xl-9 col-12 text-center">
          <div className="d-flex justify-content-center">
            <div className="d_bg_preview" ref={previewContainerRef} style={{ overflow: 'hidden' }}>
              {media && (
                <div
                  ref={containerRef}
                  style={getMediaStyle()}
