...
//                 </div>
//                 <div className="col a_main px-0">
//                     {/* Render different components based on the active menu */}
...
//         setUploadedMedia((prevMedia) => [...prevMedia, ...files]);
//     };
...
//                 </div>
//                 <div className="col a_main px-0">
//                     {/* Pass the uploaded media to the MediaComponent */}
//                     {activeMenu === 'Media' && <MediaComponent uploadedMedia={uploadedMedia}    />} 
                
//                     {/* Other components can be conditionally rendered based on activeMenu */}
//                     {activeMenu === 'Merge' && <MergeComponent />}
//                     {activeMenu === 'Ratio' && <RatioComponent />}
//                     {activeMenu === 'Text' && <TextComponent />}
//                     {activeMenu === 'Music' && <MusicComponent />}
    ...
    return (
        <>
            ...
            <div className="row">
                ...
                <div className="col a_main px-0">
                    {/* Pass the uploaded media to the MediaComponent */}
                    {activeMenu === 'Media' && <MediaComponent uploadedMedia={uploadedMedia} onMediaUpload={handleMediaUpload} />} 
                    {/* Other components can be conditionally rendered based on activeMenu */}
                    {activeMenu === 'Merge' && <MergeComponent />}
                    {activeMenu === 'Ratio' && <RatioComponent />}
                    {activeMenu === 'Text' && <TextComponent />}
